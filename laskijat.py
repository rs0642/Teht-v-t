class Laskija:
    ...
    def summaa(self, a, b):
        ...
        :param a: summan ensimmainen luku
    ...
    def kerro(self, a, b):
        ...
        :param a: tulon ensimmainen luku
        :type a: Union[int, float]
...
# Lisa MonenLaskija ja argumenttien_tulostaja tahan.


def argumenttien_tulostaja(**kwargs):
    """Tulostaa kaikki funktioon annetut avainsana-argumentti-parit.

    :param **kwargs: Avainsana-argumentti-parit
    """
    for avainsana, arvo in kwargs.items():
        print(f'Argumentin "{avainsana}" arvo is {arvo}.')


# Seuraavat rivit tekevat tarkistustulostukset. Ala koske niihin.
